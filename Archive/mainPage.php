	...
	<div class = "content">
      ...
      <div class="rejilla">
        ...
        <?php
          ...
          $link = "phpcasting.php";
          $conn = new mysqli($servername, $username, $password, $databasename);
          $result = $conn->query("SELECT Tittle, RolesLink, ShootDates FROM castingcallinfo");

          if ($result->num_rows > 0) {
              // output data of each row
              while($row = $result->fetch_assoc()) {

                echo "<a href='phpcasting.php?val=".$row['RolesLink']."'>";
                echo "<div class='caja'><img src='movies/filmImage.jpg'/>";
                echo "<p>".$row['Tittle']."</p>";
                echo "<p>Shoot Date:".$row['ShootDates']."</p>";

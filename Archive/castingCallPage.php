    ...
    <div class = "content">
      ...
      <div class="topnav" id="myTopnav">
        ...
        <br/><br/><br/>
         ...
         <form action="interestedphp.php" method="post" target="_self">

          <?php
          
          ?>
          <center><button name='interested' VALUE='1' style="height:50px; width:250px; background-color: #990026; color: #FFFFFF" >+Interested!</button></center>

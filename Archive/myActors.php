      ...
      <ul>
        ...
        if ($results->num_rows > 0) {
          ...
          while($row = $results->fetch_assoc()) {
            ...
            echo "<li><a href='phpMyActors.php?val=".$row['RolesLink']."'>".$_SESSION['filmTitle']."</a></li>";
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card-2 w3-white w3-margin-bottom">
        ...
        <hr>
        <div class="w3-container">
          <h5 class="w3-opacity"><b>Actors Interested:</b></h5><br>
          <h6 class="w3-text-darkred">
            <?php

            $index=0;
            $allName=$_SESSION['allActorName'];
              $allEmail=$_SESSION['allActorEmail'];
              $allPhone=$_SESSION['allActorPhoneNumber'];
              $allLink=$_SESSION['allActorProjectLink'];
              $allHash=$_SESSION['allActorHash'];

            while ($index<count($allName)){

              echo "<li><a href='actorphp.php?val=".$allHash[$index]."'>".$allName[$index]."<br></a></li>";
              echo "  Email: " . $allEmail[$index] . "  Phone: " . $allPhone[$index];
              echo "<li><a href='".$allLink[$index]."'>View reel<br></a></li>";
              ++$index;
            }

      ...
      <div class="w3-container w3-card-2 w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          ...
          <h6 class="w3-text-darkred">
            ...
            <?php
            echo "<b>Age Range: </b>" . $_SESSION['actorLowerAge'] . " - " . $_SESSION['actorUpperAge'] . "<br/>";




            echo "<b>Genres: </b><br>";
            echo $_SESSION['actorGenres'];


            echo "<br/>";
            echo "<b>Levels: </b><br/>";
            echo $_SESSION['actorProdLvls'];
            ?>
          </someDiv>
          </h6>
          <hr>
        ...
        <div class="w3-container">
          ...
          <h6 class="w3-text-darkred">
            <a href='<?php echo $_SESSION['actorProjectLink']; ?>' target='_blank'>Watch my reel</a>

    ...
    <center><div class="w3-twothird"></center>
      ...
      <div class="w3-container w3-card-2 w3-white w3-margin-bottom">
        ...
        <fieldset>
          ...
          <script type="text/javascript">
            ...
            function addInput(divName){
                 if (counter == limit)  {
                      ...
                      newdiv.innerHTML = "<br>"+"<b>Role </b>" + (counter + 1) +"<br>Name:" +" <br><input type='name' name='titleInputs[]'><br><br>"
          ...
          +"<option value='American Indian'>American Indian or Alaska Naitive</option>"
          ...
          +"<br><input type='int' name='roleAgeInputs[]' min='1' max='100'></input><br>"
          ...
          ;
           ...
           <form method="POST">
               <div id="dynamicInput">
                    <b>Role 1</b><br>
                    Name:<br><input type="name" name="titleInputs[]"><br><br>
                    ...
                    <label>Role age:</label><br>
                    <input type="int" name="roleAgeInputs[]" min="1" max="100"></input><br><br>
                </div>
